...
public class Test {
	...
	public static void main(String[] args) throws Throwable {
		...
		PrintWriter pw = new PrintWriter(new File("analitico-java-sequencial.csv"));
		StringBuilder sb = new StringBuilder();
		
		int LENGTH = 1000; // tamanho do vetor
		int RUNS = 19; // quantas execuções serão testadas?
		...
		for (int i = 1; i <= RUNS; i++) {
			...
			String linha = LENGTH + ";" + (endTime1 - startTime1) + "\n";
			pw.write(linha);
...
class MergeSortRunner implements Runnable {
	...
	public void run() {
		Test.parallelMergeSort(a, level);
	}
}